    ...
    <section id="about" className={styles.about}>
      ...
      <div className={styles.team}>
        <div className={styles.teamMember}>
          <img className={styles.teamMemberImage} src="team-member-1.jpg" />
          <h4>First Last</h4>
          <p>Position</p>
        </div>
        <div className={styles.teamMember}>
          <img className={styles.teamMemberImage} src="team-member-2.jpg" />
          <h4>First Last</h4>
          <p>Position</p>
        </div>
        <div className={styles.teamMember}>
          <img className={styles.teamMemberImage} src="team-member-3.jpg" />
          <h4>First Last</h4>
          <p>Position</p>
        </div>
